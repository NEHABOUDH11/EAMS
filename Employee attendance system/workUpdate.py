...
def workplantwo():
    ...
    def workUpdate():
        ...
        s="update wplan set Sunday='%s',Monday='%s',Tuesday='%s',Wednesday='%s',Thursday='%s',Friday='%s',Saturday='%s' where planid='%s'"%(b,c,d,e,f,g,h,x)
        cur.execute(s)
        db.commit()
    ...
    bt19 = Button(c, text='UPDATE', width=40, height=1,font=('Times new roman',15),command=workUpdate)
